 ...
 ***/
public class QuaggaTelnet implements Runnable, TelnetNotificationHandler
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        while (true)
        {
            ...
            try
            {
                ...
                Thread reader = new Thread (new QuaggaTelnet());
                tc.registerNotifHandler(new QuaggaTelnet());
